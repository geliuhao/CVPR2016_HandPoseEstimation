 ...
 */
#if defined(BUILDING_EXPORT_HEADER)
#if defined(BUILDING_LIBMX)
#define LIBMMWMATRIX_PUBLISHED_API DLL_EXPORT_SYM
#else
#define LIBMMWMATRIX_PUBLISHED_API DLL_IMPORT_SYM
#endif
...
#endif
#else /* defined(BUILDING_EXPORT_HEADER) */
...
#endif
#endif /* defined(BUILDING_EXPORT_HEADER) */
...
/* #endif */ /* #if !defined(BUILDING_LIBMX) */

/* contents from alloccbk.hpp */
 ...
 */
LIBMMWMATRIX_PUBLISHED_API_EXTERN_C mwIndex mxCalcSingleSubscript(const mxArray *pa, mwSize nsubs, const mwIndex *subs);
 ...
 */ 
LIBMMWMATRIX_PUBLISHED_API_EXTERN_C mxArray *mxGetFieldByNumber(const mxArray *pa, mwIndex i, int fieldnum);


/*
 * Set pa[i][fieldnum] = value 
 */
LIBMMWMATRIX_PUBLISHED_API_EXTERN_C void mxSetFieldByNumber(mxArray *pa, mwIndex i, int fieldnum, mxArray *value);
 ...
 */
LIBMMWMATRIX_PUBLISHED_API_EXTERN_C mxArray *mxGetField(const mxArray *pa, mwIndex i, const char *fieldname);
 ...
 */
LIBMMWMATRIX_PUBLISHED_API_EXTERN_C void mxSetField(mxArray *pa, mwIndex i, const char *fieldname, mxArray *value);
 ...
 */
LIBMMWMATRIX_PUBLISHED_API_EXTERN_C mxArray *mxGetProperty(const mxArray *pa, const mwIndex i, const char *propname);
 ...
 *
 */
LIBMMWMATRIX_PUBLISHED_API_EXTERN_C void mxSetProperty(mxArray *pa, mwIndex i, const char *propname, const mxArray *value);
 ...
 */
LIBMMWMATRIX_PUBLISHED_API_EXTERN_C mxArray *mxCreateNumericMatrix(mwSize m, mwSize n, mxClassID classid, mxComplexity flag);
#else
...
/* #ifndef __MATRIX_DESTROY_HPP__ */
/* #define __MATRIX_DESTROY_HPP__ */
/*
 * mxArray destructor
 */
 ...
 * \copydetails mxCreateNumericMatrixWithReuse
 */
LIBMMWMATRIX_PUBLISHED_API_EXTERN_C mxArray *mxCreateSparse(mwSize m, mwSize n, mwSize nzmax, mxComplexity flag);
 ...
 */
LIBMMWMATRIX_PUBLISHED_API_EXTERN_C mxArray *mxCreateSparseLogicalMatrix(mwSize m, mwSize n, mwSize nzmax);
 ...
 */
LIBMMWMATRIX_PUBLISHED_API_EXTERN_C void mxGetNChars(const mxArray *pa, char *buf, mwSize nChars);
 ...
 * points.
 */
LIBMMWMATRIX_PUBLISHED_API_EXTERN_C int mxGetString(const mxArray *pa, char *buf, mwSize buflen);
 ...
 * \copydetails mxCreateNumericMatrixWithReuse
 */
LIBMMWMATRIX_PUBLISHED_API_EXTERN_C mxArray *mxCreateStructMatrix(size_t m, size_t n, int nfields, const char **fieldnames);
 ...
 * \copydetails mxCreateNumericMatrixWithReuse
 */
LIBMMWMATRIX_PUBLISHED_API_EXTERN_C mxArray *mxCreateStructArray(mwSize ndim, const mwSize *dims, int nfields,
